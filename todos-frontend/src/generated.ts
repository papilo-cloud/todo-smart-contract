...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link todosAbi}__ and `functionName` set to `"EMPTY_TODOS"`
 */
export const useReadTodosEmptyTodos = /*#__PURE__*/ createUseReadContract({
  abi: todosAbi,
  functionName: 'EMPTY_TODOS',
})
